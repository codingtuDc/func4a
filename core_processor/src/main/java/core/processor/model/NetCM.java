...
import static core.processor.StaticData.CLASS_NAME_NET;
import static core.processor.StaticData.CLASS_NAME_NET_UTILS;
import static core.processor.StaticData.PACKAGE_NET;
...
public class NetCM extends ClassModel {
    ...
    public NetCM() {
        super(PACKAGE_NET, CLASS_NAME_NET);
    ...
    public void addMethod(TypeElement te, BaseUrl baseUrl, ExecutableElement ee) {
        ...
        addLines(methodLinesIndex, ") {\r\n");
        addLines(methodLinesIndex, "    return " + CLASS_NAME_NET_UTILS + ".api(new NetUtils.CreateApi() {\r\n");
